...
const LandingPage = () => (
  <main className="relative bg-white">
    ...
    <div className="max-w-6xl mx-auto p-4 sm:px-6">
      <div className="p-5 rounded-md border-2 border-gray-200 flex-col">
        ...
        <div className="flex flex-wrap justify-around">
          <div className="md:w-5/12 md:p-2 px-6 pb-2 mt-2 md:px-2 w-full flex flex-col items-center md:block border-b-2 border-t-2 md:border-0">
            ...
            <ul className="list-disc md:w-full w-10/12">
              ...
              <li className="p-2">
                <p>
                  Helps manage and track the habits you are trying to build.
                </p>
                <div className="p-2 bg-gray-200 rounded-md m-4">
                  <p className="text-gray-600 text-sm">
                    Studies show that it takes on average 66 days to build a
                    habit, but that's just an average. It may take 2 days to
                    maybe never. Use this to visually track the habit you are
                    trying to build, or make it a practice you strive to achieve
                    every day.
                  </p>
                </div>
              </li>
          ...
          <div className="md:w-5/12 md:p-2 px-6 md:px-2 w-full flex flex-col items-center md:block">
            ...
            <ul className="list-disc md:w-full w-10/12">
              ...
              <li className="p-2">
                <p>
                  Allows you to save keywords that are used to generate a list
                  of posts that have been found for future reading.
                </p>
              </li>
            </ul>
          </div>
