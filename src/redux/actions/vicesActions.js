...
export const VICES_ARCHIVED_FETCHING = 'VICES_ARCHIVED_FETCHING';
export const VICES_ARCHIVED_FETCHING_DONE = 'VICES_ARCHIVED_FETCHING_DONE';
export const VICES_ARCHIVED_FETCHING_ERROR = 'VICES_ARCHIVED_FETCHING_ERROR';
